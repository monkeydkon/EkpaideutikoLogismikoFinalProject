...
public class IfsSecondTestThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ifs_second_test_third);
        ...
        mDatabase.child("questions").child("ifs").child("for").child("second").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId){
                    case R.id.first:
                        mDatabase.child("questions").child("ifs").child("for").child("second").child("answers").child("correct").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Intent intent = new Intent(getApplicationContext(),IfsSecondTestFourthActivity.class);
