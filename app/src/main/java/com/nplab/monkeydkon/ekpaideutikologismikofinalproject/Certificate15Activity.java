...
public class Certificate15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("questions").child("ifs").child("while").child("second").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId){
                    case R.id.first:
                        mDatabase.child("questions").child("ifs").child("while").child("second").child("answers").child("correct").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // TODO: 25/6/2018  
//                Intent intent = new Intent(getApplicationContext(), Certificate16Activity.class);
