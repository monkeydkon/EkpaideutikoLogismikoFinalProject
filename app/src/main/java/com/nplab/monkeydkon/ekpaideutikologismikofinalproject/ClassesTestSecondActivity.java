...
public class ClassesTestSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classes_test_second);
        ...
        mDatabase.child("users").child(username).child("classesProgress").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if((Boolean)dataSnapshot.child("classesfalse").getValue()){
                    extra++;
                    if(extra == 1){
                        showMessage("Extra Question","A class can only have methods", false);
                    }
                    return;
...
//                }
        ...
        mDatabase.child("users").child(username).child("classesProgress").child("classesfalse").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                classe=(boolean)dataSnapshot.getValue(); //get "false" value from firebase
            }
        ...
        mDatabase.child("questions").child("classes").child("classes").child("first").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId){
                    case R.id.first:
                        mDatabase.child("questions").child("classes").child("classes").child("first").child("answers").child("correct").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (Integer.parseInt(dataSnapshot.getValue().toString()) != 1){
                                    ...
                                    classe=true;
                                    if(classe) //if you did a mistake on OOP
                                    {
                                        mDatabase.child("users").child(username).child("classesProgress").child("classesfalse").setValue(classe); //set value to true
                                    }
                ...
                Intent intent = new Intent(getApplicationContext(),ClassesTestThirdActivity.class);
