...
public class ClassesTestThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classes_test_third);
        ...
        mDatabase.child("users").child(username).child("classesProgress").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if((Boolean)dataSnapshot.child("returntypesfalse").getValue()){
                    extra++;
                    if(extra == 1){
                        showMessage("Extra Question","You can return a value in an if statement", false);
                    }
                    return;
...
//                }
        ...
        mDatabase.child("users").child(username).child("classesProgress").child("returntypesfalse").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId){
                    case R.id.first:
                        mDatabase.child("questions").child("classes").child("returnType").child("first").child("answers").child("correct").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Intent intent = new Intent(getApplicationContext(),ClassesTestFourthActivity.class);
